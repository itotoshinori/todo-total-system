class TodosController < ApplicationController
  ...
  def index
    ...
    if cookies[:udemy_time_check15].blank? and request.os == 'Android' and @userid.to_s == "1"
      begin
        ...
        title = "Udemyバーゲン購入検討"
        #title = "関西歴史建造物"
        @udemy_check = @scrap.check(@userid,url,title,"勇者ヨシヒコ","対象コース","バーゲン")
        cookies[:udemy_time_check15] = { :value => @udemy_check, :expires => 12.hours.from_now } 
