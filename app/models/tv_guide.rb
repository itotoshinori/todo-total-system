class Tv_guide
  def schedule_add(userid)
    target_list = ["路線バス","松本清張","織田信長","豊臣秀吉","足利","重塔","平家","源氏""歴史探偵",
    "巨人 プロ野球 中継","水曜日のダウンタウン","サッカー 日本代表 中継","新庄剛志","金村義明",
    "江本孟紀","中田敦彦","吉永小百合","武田邦彦","池上彰","堀江貴文",
    "野村克也","西村博之","松村邦洋","役所広司","緒方拳",
    "青春１８","奄美大島","石垣島","与那国島","大雪山","知床","アルプス"] 
    main_titles = []
    tV_program = []
