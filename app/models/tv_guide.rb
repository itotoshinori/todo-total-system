class Tv_guide
  def schedule_add(userid)
    target_list = ["松本清張","鎌倉時代","平安時代","室町時代","戦国時代","織田信長","豊臣秀吉","重塔","平家","源氏","歴史探偵","巨人 プロ野球 中継","サッカー 日本代表 中継","青天を衝（つ）け 【作】大森美香","新庄剛志","金村義明","江本孟紀","中田敦彦","吉永小百合","武田邦彦","池上彰","堀江貴文","西村博之","松村邦洋","役所広司","池谷実悠"] 
    main_titles = []
    tV_program = []
