...
class Tv_guide
  def schedule_add(userid)
    target_list = ["松本清張","田中邦衛 ドラマ","歴史探偵","巨人 プロ野球 中継","サッカー 日本代表 中継","青天を衝（つ）け 【作】大森美香","新庄剛志","金村義明","朝まで生テレビ","江本孟紀","中田敦彦","織田信長","重塔","法隆寺","平家","吉永小百合","武田邦彦","豊臣秀吉","池上彰","堀江貴文","西村博之","松村邦洋","役所広司"] 
    main_titles = []
    tV_program = []
