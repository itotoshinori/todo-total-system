...
class Tv_guide
  def schedule_add(userid)
    target_list = ["新庄剛志","金村義明","江本孟紀","池澤あやか","中田敦彦","杉原杏璃","豊田真由子","八田亜矢子","田原総一郎","広瀬すず","朝まで生テレビ","サッカー日本代表","織田信長","橋下徹","武田邦彦","豊臣秀吉","堀江貴文","堺雅人","吉永小百合","蒼井優","黒木華","役所広司","源氏","平家","法隆寺","国宝寺","五重塔","三重塔","天守閣","松村邦彦"] 
    main_titles = []
    tV_program = []
