class Weatheritem
  ...
  "few clouds"=>{"ja"=>"晴くもり","icon"=>"fewclouds.png"},
  "broken clouds"=>{"ja"=>"くもり","icon"=>"brokenclouds.png"},
  "scattered clouds"=>{"ja"=>"くもり","icon"=>"scatteredclouds.png"},
  "overcast clouds"=>{"ja"=>"くもり","icon"=>"overcastclouds.png"},
  "light intensity shower rain"=>{"ja"=>"小雨","icon"=>"lightintensityshowerrain.png"},
  "shower rain"=>{"ja"=>"にわか雨","icon"=>"showerrain.png"},
  "heavy intensity shower rain"=>{"ja"=>"大雨","icon"=>"rain.png"},
  "light rain"=>{"ja"=>"小雨","icon"=>"lightrain.png"},
  "moderate rain"=>{"ja"=>"雨","icon"=>"rain.png"},
  "heavy intensity rain"=>{"ja"=>"大雨","icon"=>"rain.png':"},
  "very heavy rain"=>{"ja"=>"強い大雨","icon"=>"rain.png"},
  "rain"=>{"ja"=>"雨","icon"=>"rain.png"},
  "thunderstorm"=>{"ja"=>"雷雨","icon"=>"thunderstorm.png"},
  "light snow"=>{"ja"=>"雪","icon"=>"snow.png"},
   "snow"=>{"ja"=>"雪","icon"=>"snow.png"},
   "mist"=>{"ja"=>"霧","icon"=>"mist.png"},
