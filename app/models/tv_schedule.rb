class Tv_schedule
  def schedule_add(userid)
    ...
    talents = [
      ["新庄剛志","0000204772"],["","0000140552"],["上原浩治","0000203130"],
      ["堀江貴文","1000033841"],["池澤あやか","1000062953"],["西村博之","1000076695"],
      ["武田邦彦","1000061975"],["ケント・ギルバート","0000006314"],
      ["八田亜矢子","1000046588"],["杉原杏璃","1000074541"],["豊田真由子","2000054878"],
      #["田原総一朗","0000011079"],["宅麻伸","0000000471"],["沢村一樹","0000010513"]
      ["中田敦彦","1000042081"],["橋下徹","1000003362"],["江本孟紀","0000014456"],
      ["山田孝之","0000258788"],["ムロツヨシ","1000044428"]
    ]
