class Tv_schedule
  def schedule_add(userid)
    ...
    ["テレビ朝日","NHK総合・東京","フジテレビ","TOKYO MX1","日本テレビ","TBS","テレビ東京","BSフジ","BSテレ東","BS日本","BS-TBS","BS朝日"]
    #,"NHK Eテレ・東京"除外
    talents = [
      ["新庄剛志","0000204772"],["金村義明","0000140552"],["江本孟紀","0000014456"],["山崎武司","1000058631"],
      ["堀江貴文","1000033841"],["池澤あやか","1000062953"],["落合陽一","2000009546"],["田原総一朗","0000011079"],
      ["武田邦彦","1000061975"],["ケント・ギルバート","0000006314"],
      ["八田亜矢子","1000046588"],["杉原杏璃","1000074541"],["豊田真由子","2000054878"],
      ["中田敦彦","1000042081"],["厚切りジェイソン","2000003034"],["松村邦洋","0000003897"],
      ["池井戸潤","0000226263"],["長谷川博己","1000023020"],
      ["堺雅人","0000009862"],["蒼井優","0000138133"],
      ["安藤サクラ","1000065746"],["黒木華","1000078969"],["松坂慶子","0000004682"],
      ["吉永小百合","0000004628"],



      #["タモリ","0000002674"],
      #["村本大輔","1000074821"],["マツコ","1000045911"],["新垣結衣","1000021348"],
      #["杉村太蔵","1000047120"],["有吉弘行","0000096561"],
      #["木南晴夏","1000020942"],["平石直之","1000013502"],
      #["吉田羊","1000061502"],["村本大輔","1000074821"],["小芝風花","1000087753"]
      #["佐藤二朗","0000127081"],["マツコ","1000045911"],["西田敏行","0000000881"],
      #["池上彰","0000226370"]#["山口真由","2000016994"] ["ムロツヨシ","1000044428"],
      #["新垣結衣","1000021348"],["有吉弘行","0000096561"],,["おいでやす小田","1000085039"]#["宅麻伸","0000000471"],
      #["高橋茂雄","1000002027"],["杉村太蔵","1000047120"],["田原総一朗","0000011079"],
      #,["ぱるる","1000084644"],["西田敏行","0000000881"],
      #["山本太郎","0000005653"],["三浦瑠麗","2000002308"],
      #["平石直之","1000013502"],["おいでやす小田","1000085039"]
      #["橋下徹","1000003362"],["豊田真由子","2000054878"],["西村博之","1000076695"]
    ]
